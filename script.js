...
const deleteProducts = async () => {
  const baseURL = "http://127.0.0.1:5000/products"; // Update this to match your Flask server

  // Example: Change axios.get(url) to axios.get(baseURL + url)
...
var checkout = async () => {
    ...
    try {
      ...
      // Updated payment url
      var paymentUrl = "https://scnv.io/gLgP";
